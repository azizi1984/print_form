                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center align-items-center flex-nowrap gap-1">
                                <a href="{{ route('footer-template.show', $row['footer_template_id'] ?? $row->footer_template_id) }}" class="btn-action btn-action-view" title="จัดการ Layout">
                                    <i class="bi bi-layout-text-window"></i>
                                </a>
                                <a href="#" class="btn-action btn-action-copy copy-btn" title="คัดลอกเทมเพลต" data-id="{{ $row['footer_template_id'] ?? $row->footer_template_id }}">
                                ...
                                <a href="#" class="btn-action btn-action-edit" title="แก้ไขข้อมูล"
                                   ...
                                   data-date="{{ !empty($row['created_at']) ? \Carbon\Carbon::parse($row['created_at'])->format('d/m/Y H:i') : '' }}">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <small class="text-muted" id="editModalSubtitle">
                            กำหนดชื่อและรายละเอียดเทมเพลตส่วนท้ายเอกสารและลายเซ็น (Footer Template) สำหรับใบขนสินค้าขาออก
                        </small>
                    </div>
                </div>
            ...
            <div class="modal-body p-4">
                ...
                <form id="createOrEditForm">
                    ...
                    <!-- Template Name Field -->
                    <div class="mb-3">
                        <label for="create_or_edit_footer_template_name" class="form-label fw-semibold text-dark d-flex justify-content-between align-items-center">
                            <span><i class="bi bi-tag text-primary me-1"></i> Footer Template Name <span class="text-danger">*</span></span>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-start-0 ps-1" id="create_or_edit_footer_template_name" name="footer_template_name" placeholder="เช่น Standard Export Footer Template" required autocomplete="off">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text text-muted" style="font-size: 12px;">
                            <i class="bi bi-pencil me-1"></i>ระบุข้อมูลสั้น ๆ เพื่อช่วยจดจำวัตถุประสงค์หรือรายละเอียดของเทมเพลต
                        </div>
                    </div>
            ...
            <div class="modal-footer bg-light-subtle border-top py-3 px-4 d-flex justify-content-between align-items-center">
                <div class="text-muted small d-none d-sm-flex align-items-center">
                    ...
                    <span>พร้อมรองรับการกำหนด Footer & Signature Layout</span>
                </div>
