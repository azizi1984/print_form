                    ...
                    <table id="ex_declaration" class="table table-striped table-bordered table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row['profile_template_name'] }}</td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-center flex-nowrap gap-2">
                                        ...
                                        <a href="#" class="text-danger delete-btn" title="Delete" data-id="{{ $row['profile_template_id'] ?? '' }}"><i class="bi bi-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="editModalLabel"><i class="bi bi-journal-text me-2"></i>Create / Edit Template</h5>
                ...
                <div class="modal-body">
                    <form id="createOrEditForm">
                        ...
                        <div class="mb-3">
                            <label for="create_or_edit_profile_template_name" class="form-label">Profile Template Name <span class="text-danger">*</span></label>
