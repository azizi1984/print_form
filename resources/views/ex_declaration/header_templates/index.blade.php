    ...
    <div class="container-fluid px-4 mt-4 mb-5">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold"><i class="bi bi-file-earmark-arrow-up me-2"></i>Export Declaration Header Templates</h5>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="header_declaration" class="table table-striped table-bordered table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row['header_template_name'] }}</td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-center flex-nowrap gap-2">
                                        ...
                                        <a href="#" class="text-danger delete-btn" title="Delete" data-id="{{ $row['header_template_id'] ?? '' }}"><i class="bi bi-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="editModalLabel"><i class="bi bi-journal-text me-2"></i>Create / Edit Header Template</h5>
                ...
                <div class="modal-body">
                    <form id="createOrEditForm">
                        ...
                        <div class="mb-3">
                            <label for="create_or_edit_header_template_name" class="form-label">Header Template Name <span class="text-danger">*</span></label>
