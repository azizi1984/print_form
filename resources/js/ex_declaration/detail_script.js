        ...
        createOrEditModal.addEventListener('show.bs.modal', function (event) {
            ...
            if (button) {
                ...
                if (id) {
                    ...
                    document.getElementById('editModalLabel').innerHTML = '<i class="bi bi-pencil-square me-2"></i>Edit Detail Template';
                    document.getElementById('wrapper_created_at').style.display = 'block';
                } else {
                    // โหมด Create
                    document.getElementById('action_mode').value = 'create';
                    document.getElementById('editModalLabel').innerHTML = '<i class="bi bi-plus-lg me-2"></i>Create Detail Template';
